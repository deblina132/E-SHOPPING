...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('women gif.gif'); /* Add your background image URL here */
...
<body>
    ...
    <div class="items-grid">
        <!-- Sample item card -->
        <div class="item-card">
            <img src="women casual.jpeg" alt="Casual Dress" class="item-image">
            <div class="item-details">
                <p class="item-name">Casual Dress</p>
                <p class="item-price">&#8377;629</p>
                <button class="buy-now-btn" onclick="addToCart('Casual Dress', '$#8377;629')">Buy Now</button>
            </div>
        </div>
        ...
        <div class="item-card">
            ...
            <div class="item-details">
                ...
                <button class="buy-now-btn" onclick="addToCart('Formal Dress', '&#8377;1959')">Buy Now</button>
            </div>
        </div>
        ...
        <div class="item-card">
            ...
            <div class="item-details">
                ...
                <button class="buy-now-btn" onclick="addToCart('Sunglasses', '#8377;589')">Buy Now</button>
            </div>
        </div>
        ...
        <div class="item-card">
            ...
            <div class="item-details">
                ...
                <button class="buy-now-btn" onclick="addToCart('SweatShirts', '#8377;899')">Buy Now</button>
            </div>
        </div>
    </div>
